...
public class PipeMonthlyCheck extends PipeBaseEntity {

	public static PipeMonthlyCheck pipeMonthlyCheck = null;
	...
	public static PipeMonthlyCheck getInstance() {
		if (pipeMonthlyCheck == null) {
			pipeMonthlyCheck = new PipeMonthlyCheck();
		}
		return pipeMonthlyCheck;
	}
